      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center lg:gap-14">
          <div className="order-1 text-center text-white lg:order-1 lg:col-span-7 lg:row-start-1 lg:text-right">
            ...
            <p className="mx-auto mt-5 max-w-xl whitespace-pre-line text-base leading-7 text-white/78 sm:mt-6 sm:text-lg sm:leading-8 lg:mx-0">
          ...
          <div className="order-3 mx-auto grid w-full max-w-lg grid-cols-3 items-center justify-items-center gap-3 rounded-3xl border border-white/10 bg-white/[0.03] p-4 shadow-brand sm:gap-5 sm:p-5 lg:order-3 lg:col-span-7 lg:col-start-1 lg:row-start-2 lg:mx-0 lg:mt-2">
            <Stat number="+20" label="שנות ניסיון" />
            <Stat number="+5,000" label="פרויקטים" />
